...
const EXPLORED_GROUPS = [
    { 
        ...
        achIcon: 'ach_general.png', appIcon: 'icon_app_general.png', rewardDays: 30,
...
const CHANGELOG_DATA = [
    {
        ...
        date: "Feb 2026",
        changes: {
            en: ["Added support for custom third-party sites 🌐."],
            ru: ["Добавлена возможность добавлять свои сайты 🌐."],
            es: ["Añadida la posibilidad de agregar sitios personalizados 🌐."],
            de: ["Möglichkeit hinzugefügt, eigene Websites hinzuzufügen 🌐."]
        }
    },
    {
        ver: "0.2",
...
let claimedRewards = JSON.parse(localStorage.getItem('xch_claimed_rewards')) || [];

let lastGenerationMode = 'random';
...
const SITES_DATA = [
    ...
    { 
        id: 't8', name: 'Tube8', 
        url: 'https://www.tube8.com/searches.html/?q={q}', sep: '+',
        tags: ['hardcore', 'long'],
    ...
    { 
        ...
        url: 'https://www.porn.com/search?sq={q}', sep: '-',
        tags: ['general'],
    ...
    { 
        ...
        url: 'https://pornone.com/search?q={q}', sep: '+', 
        tags: ['general'],
    ...
    { 
        id: 'tna', name: 'TnaFlix', 
        url: 'https://www.tnaflix.com/search?what={q}', sep: '+', 
        tags: ['retro', 'amateur'],
...
// Хранилище всех кастомных модов
let customModifiersList = [];
try {
    const savedCustom = JSON.parse(localStorage.getItem('xch_custom_mods'));
    customModifiersList = Array.isArray(savedCustom) ? savedCustom : [];
} catch (e) {
    customModifiersList = [];
}
...
const langData = {
    en: {
        ...
        add_site_btn: "Add Custom Site",
        add_site_title: "Add New Site",
        add_site_instr_title: "INSTRUCTION:",
        add_site_step_1: "Go to the site you want to add.",
        add_site_step_2: "Search for the word <b>test</b>.",
        add_site_step_3: "Copy the result URL and paste below.",
        lbl_site_name: "NAME",
        lbl_site_url: "URL RESULT",
        lbl_site_desc: "DESCRIPTION",
        btn_save: "Save",
        btn_delete: "Delete",
        ...
        tip_badge_title: "Smart Alerts",
        tip_badge_desc: "Enable badge & in-app popups",
        tip_badge_text: `
            <b>How it works:</b><br>
            Enabling notifications activates two things:<br>
            1. <b>Red Dot (Badge):</b> A discreet number on the app icon.<br>
            2. <b>In-App Alerts:</b> Helpful pop-ups inside the app (like "Wrapped Ready" or "Subscription Ending").<br><br>
            
            <b>Privacy First:</b><br>
            We <b>do not</b> send external Push Notifications to your lock screen. You will only see these alerts while using the app or looking at the icon. No spam, ever.
        `,
        ...
        tip_dict_text: `
            <b>🎥 Formats & Styles</b><br>
            <b>POV (Point of View):</b> Filmed through the actor's eyes. You are the protagonist.<br>
            <b>PMV (Porn Music Video):</b> Clips edited to the rhythm of music.<br>
            <b>Gonzo:</b> Raw, unscripted action where the cameraperson interacts.<br>
            <b>JOI (Jerk Off Instruction):</b> The model tells you exactly how and when to touch yourself.<br>
            <b>ASMR:</b> Whispers and sounds for brain-tingling relaxation.<br><br>

            <b>👥 Body Types</b><br>
            <b>MILF / GILF:</b> Experienced Moms / Grandmas.<br>
            <b>BBW:</b> Big Beautiful Women (Plus-size).<br>
            <b>SSBBW:</b> Super Size BBW. Even bigger and softer.<br>
            <b>PAWG:</b> Phat Ass White Girl.<br>
            <b>Futanari:</b> Anime girls with a penis (best of both worlds).<br><br>

            <b>⛓️ Kink & Hardcore</b><br>
            <b>BDSM:</b> Bondage, Dominance, Sadism, Masochism.<br>
            <b>CNC (Consensual Non-Consent):</b> Roleplay involving forced scenarios (Safe & Sane).<br>
            <b>CBT (Cock and Ball Torture):</b> Painful play with male genitals.<br>
            <b>SPH (Small Penis Humiliation):</b> Mocking size for pleasure.<br>
            <b>A2M (Ass to Mouth):</b> Going straight from the backdoor to the mouth.<br>
            <b>Creampie:</b> Finishing inside. A timeless classic.<br>
            <b>Shibari:</b> The artistic Japanese form of rope bondage.
        `,
        ...
        tip_vpn_region_title: "Best VPN Region for 18+",
        tip_vpn_region_desc: "Where to connect for zero blocks",
        tip_vpn_region_text: `
            Choosing the right server is key to avoiding "Access Denied" screens or annoying ID verifications.<br><br>
            
            <b>🇳🇱 Netherlands (The Gold Standard)</b><br>
            The best region for adult content. All major networks (Aylo/Pornhub, XVideos, xHamster) and niche sites are 100% accessible without restrictions.<br><br>
            
            <b>🇺🇸 USA (The "Red State" Problem)</b><br>
            Unstable. 23+ states (like Texas, Virginia, Utah) have passed age-verification laws. If your VPN lands there, Pornhub and others will simply <b>block access</b>. Avoid USA servers if you want a smooth experience.<br><br>
            
            <b>🇮🇳 India & 🇦🇪 Middle East</b><br>
            Strict censorship. Almost all mainstream and niche adult sites are blocked at the ISP level. Do not use these regions.<br><br>
            
            <b>💡 Pro Tip:</b> Set your VPN to <b>Netherlands, Switzerland, or Canada</b> for the most reliable and private access.
        `,
        ...
        export_title_select: "Export Data",
        export_desc_select: "Select data to export as a JSON file for AI analysis.",
        export_opt_lists: "Lists (Liked/Disliked)",
        export_opt_hist: "History & Watch Time",
        export_opt_activity: "Detailed Activity Log",
        btn_export_selected: "Download JSON",
        ...
        feat_custom_sites: "🌐 <b>Add Custom</b> Sites",
        ...
        feat_export: "💾 Data Export (JSON)",
        
        tip_export_title: "Export & AI Analysis",
        tip_export_desc: "Analyze your tastes with ChatGPT",
        tip_export_text: `
            Did you know you can export your entire browsing history and feed it to an AI? Our JSON export is formatted specifically for neural networks to understand.<br><br>
            <b>How to do it:</b><br>
            1. Go to the <b>Account</b> tab and click 'Sync Data' (the cloud icon).<br>
            2. Click the <b>Export Data</b> button (Premium feature).<br>
            3. Choose what to export and download the JSON file.<br><br>
            <b>What's next?</b><br>
            Upload this file to ChatGPT or Claude and prompt:<br>
            <i style="color:var(--text-secondary);">"Analyze my viewing history and swipes. What are my hidden psychological preferences? What specific fetish should I try next based on these patterns?"</i><br><br>
            The AI will perfectly process your actions and tags, giving you a detailed psychoanalysis of your kinks!
        `,
    ...
    ru: {
        ...
        add_site_btn: "Добавить свой сайт",
        add_site_title: "Новый сайт",
        add_site_instr_title: "ИНСТРУКЦИЯ:",
        add_site_step_1: "Зайди на сайт, который хочешь добавить.",
        add_site_step_2: "В поиске напиши слово <b>test</b> и нажми найти.",
        add_site_step_3: "Скопируй ссылку из браузера с результатами и вставь ниже.",
        lbl_site_name: "НАЗВАНИЕ",
        lbl_site_url: "ССЫЛКА (с 'test')",
        lbl_site_desc: "ОПИСАНИЕ",
        btn_save: "Сохранить",
        btn_delete: "Удалить",

        reward_days: "{n} дн.",
        reward_claimed_status: "Забрано",
        ...
        tip_badge_title: "Умные уведомления",
        tip_badge_desc: "Включить бейдж и всплывашки",
        tip_badge_text: `
            <b>Как это работает:</b><br>
            Включение уведомлений активирует две функции:<br>
            1. <b>Красная точка (Бейдж):</b> Цифра на иконке приложения.<br>
            2. <b>Внутренние алерты:</b> Всплывающие сообщения внутри приложения (например, "Wrapped готов" или "Подписка истекает").<br><br>
            
            <b>Приватность:</b><br>
            Мы <b>не отправляем</b> пуш-уведомления на экран блокировки. Ты увидишь эти сообщения, только когда откроешь приложение. Никакого спама.
        `,
        ...
        tip_dict_text: `
            <b>🎥 Форматы и стили</b><br>
            <b>POV (точка зрения):</b> Снято глазами актера. Вы — главный герой.<br>
            <b>PMV (порно-музыкальное видео):</b> Клипы, смонтированные в ритме музыки.<br>
            <b>Gonzo:</b> Неотредактированное действие без сценария, в котором участвует оператор.<br>
            <b>JOI (Jerk Off Instruction):</b> Модель точно говорит вам, как и когда трогать себя.<br>
            <b>ASMR:</b> Шепот и звуки для расслабляющего воздействия на мозг.<br><br>

            <b>👥 Типы телосложения</b><br>
            <b>MILF / GILF:</b> Опытные мамы / бабушки.<br>
            <b>BBW:</b> Красивые полные женщины (плюс-сайз).<br>
            <b>SSBBW:</b> Супер-размерные BBW. Еще больше и мягче.<br>
            <b>PAWG:</b> белые девушки с большими задницами.<br>
            <b>Futanari:</b> аниме-девушки с пенисом (лучшее из обоих миров).<br><br>

            <b>⛓️ Кинк и хардкор</b><br>
            <b>BDSM:</b> бондаж, доминирование, садизм, мазохизм.<br>
            <b>CNC (Consensual Non-Consent):</b> Ролевые игры с принудительными сценариями (безопасными и разумными).<br>
            <b>CBT (Cock and Ball Torture):</b> Болезненные игры с мужскими гениталиями.<br>
            <b>SPH (Small Penis Humiliation):</b> Издевательства над размером для удовольствия.<br>
            <b>A2M (Ass to Mouth):</b> Переход прямо из заднего прохода в рот.<br>
            <b>Creampie:</b> Завершение внутри. Вечная классика.<br>
            <b>Shibari:</b> Художественная японская форма связывания веревками.
        `,
        ...
        tip_vpn_region_title: "Лучший VPN регион для 18+",
        tip_vpn_region_desc: "Куда подключаться для доступа без границ",
        tip_vpn_region_text: `
            Выбор правильного сервера — это разница между «Видео доступно» и экраном блокировки или требованием паспорта.<br><br>
            
            <b>🇳🇱 Нидерланды (Золотой стандарт)</b><br>
            Лучший выбор для взрослого контента. Все крупные сети (Pornhub, XVideos, xHamster) и нишевые сайты доступны на 100% без ограничений.<br><br>
            
            <b>🇺🇸 США (Проблема штатов)</b><br>
            Нестабильно. Более 23 штатов (Техас, Вирджиния, Юта и др.) ввели законы о проверке возраста. Если ваш VPN выдаст IP такого штата, Pornhub просто <b>закроет доступ</b>. Избегайте серверов США.<br><br>
            
            <b>🇮🇳 Индия и 🇦🇪 Ближний Восток</b><br>
            Жесткая цензура. Почти все сайты (Mainstream, Hentai, Niche) заблокированы на уровне провайдеров. Эти регионы бесполезны.<br><br>
            
            <b>💡 Совет:</b> Всегда выбирайте <b>Нидерланды, Швейцарию или Румынию</b> для самого быстрого и свободного доступа.
        `,
        ...
        export_title_select: "Экспорт данных",
        export_desc_select: "Выберите данные для выгрузки в формате JSON. Идеально для нейросетей.",
        export_opt_lists: "Списки (Лайки/Дизлайки)",
        export_opt_hist: "История и Время просмотра",
        export_opt_activity: "Лог активности (свайпы)",
        btn_export_selected: "Скачать JSON",
        ...
        feat_custom_sites: "🌐 <b>Свои</b> Сайты",
        ...
        feat_export: "💾 Экспорт данных (JSON)",
        
        tip_export_title: "Экспорт и нейросети",
        tip_export_desc: "Анализ своих вкусов через ChatGPT",
        tip_export_text: `
            Знаешь ли ты, что можешь выгрузить всю свою историю и скормить её нейросети? Наш файл выгрузки отформатирован так, чтобы ИИ понял каждое твое действие.<br><br>
            <b>Как это сделать:</b><br>
            1. Зайди во вкладку <b>Аккаунт</b> и нажми на блок Личного кабинета (с облаком).<br>
            2. Нажми <b>Экспорт данных</b> (Доступно в Premium).<br>
            3. Выбери нужные пункты и скачай JSON файл.<br><br>
            <b>Что дальше?</b><br>
            Загрузи этот файл в ChatGPT или Claude и напиши:<br>
            <i style="color:var(--text-secondary);">"Проанализируй мою историю просмотров и лайков. Какие у меня скрытые психологические предпочтения? Какой новый фетиш мне стоит попробовать на основе этих данных?"</i><br><br>
            Нейросеть отлично понимает этот формат данных и выдаст тебе подробнейший психоанализ твоих предпочтений!
        `,
    ...
    es: {
        ...
        add_site_btn: "Añadir sitio personalizado",
        add_site_title: "Añadir nuevo sitio",
        add_site_instr_title: "INSTRUCTION:",
        add_site_step_1: "Vaya al sitio que desea añadir.",
        add_site_step_2: "Busque la palabra <b>test</b>.",
        add_site_step_3: "Copie la URL resultante y péguela a continuación.",
        lbl_site_name: "NAME",
        lbl_site_url: "URL RESULTADO",
        lbl_site_desc: "DESCRIPTION",
        btn_save: "Guardar",
        btn_delete: "Borrar",

        reward_days: "{n} días",
        reward_claimed_status: "Recibido",
        ...
        tip_badge_title: "Alertas Inteligentes",
        tip_badge_desc: "Activar insignia y mensajes",
        tip_badge_text: `
            <b>Cómo funciona:</b><br>
            Activar las notificaciones habilita dos cosas:<br>
            1. <b>Punto Rojo (Insignia):</b> Un número discreto en el icono de la app.<br>
            2. <b>Alertas en la App:</b> Mensajes emergentes útiles dentro de la aplicación (como "Wrapped Listo" o "Suscripción Terminando").<br><br>
            
            <b>Privacidad ante todo:</b><br>
            Todavía <b>no enviamos</b> notificaciones push a tu pantalla de bloqueo. Solo verás estas alertas mientras usas la app. Sin spam, nunca.
        `,
        ...
        tip_dict_text: `
            <b>🎥 Formatos y estilos</b><br>
            <b>POV (punto de vista):</b> Filmado a través de los ojos del actor. Tú eres el protagonista.<br>
            <b>PMV (vídeo musical porno):</b> Clips editados al ritmo de la música.<br>
            <b>Gonzo:</b> Acción cruda y sin guion en la que el cámara interactúa.<br>
            <b>JOI (Jerk Off Instruction):</b> La modelo te dice exactamente cómo y cuándo tocarte.<br>
            <b>ASMR:</b> Susurros y sonidos para una relajación que te hará vibrar el cerebro.<br><br>

            <b>👥 Tipos de cuerpo</b><br>
            <b>MILF / GILF:</b> Madres / abuelas con experiencia.<br>
            <b>BBW:</b> Mujeres grandes y hermosas (talla grande).<br>
            <b>SSBBW:</b> BBW de talla extragrande. Aún más grandes y suaves.<br>
            <b>PAWG:</b> Chicas blancas con culos grandes.<br>
            <b>Futanari:</b> Chicas de anime con pene (lo mejor de ambos mundos).<br><br>

            <b>⛓️ Kink y hardcore</b><br>
            <b>BDSM:</b> Bondage, dominación, sadismo, masoquismo.<br>
            <b>CNC (Consensual Non-Consent):</b> Juego de rol que implica situaciones forzadas (seguro y sensato).<br>
            <b>CBT (Cock and Ball Torture):</b> Juego doloroso con los genitales masculinos.<br>
            <b>SPH (Small Penis Humiliation):</b> Burlarse del tamaño para obtener placer.<br>
            <b>A2M (del culo a la boca):</b> Pasar directamente de la puerta trasera a la boca.<br>
            <b>Creampie:</b> Correrse dentro. Un clásico atemporal.<br>
            <b>Shibari:</b> La forma artística japonesa de bondage con cuerdas.
        `,
        ...
        tip_vpn_region_title: "Mejor Región VPN para +18",
        tip_vpn_region_desc: "Dónde conectarse para evitar bloqueos",
        tip_vpn_region_text: `
            Elegir el servidor adecuado es clave para evitar pantallas de "Acceso denegado" o verificaciones de identidad.<br><br>
            
            <b>🇳🇱 Países Bajos (El Estándar de Oro)</b><br>
            La mejor región para contenido adulto. Todas las redes (Pornhub, XVideos, xHamster) y sitios de nicho son 100% accesibles sin restricciones.<br><br>
            
            <b>🇺🇸 EE. UU. (Problemas de Verificación)</b><br>
            Inestable. Más de 23 estados (como Texas o Utah) exigen verificación de edad. Si tu VPN te asigna allí, sitios como Pornhub <b>bloquearán el acceso</b>. Evita los servidores de EE. UU.<br><br>
            
            <b>🇮🇳 India y 🇦🇪 Medio Oriente</b><br>
            Censura estricta. Casi todos los sitios mainstream y de Hentai están bloqueados por los proveedores de internet. No uses estas regiones.<br><br>
            
            <b>💡 Pro Tip:</b> Configura tu VPN en <b>Países Bajos, Suiza o Rumania</b> para el acceso más confiable.
        `,
        ...
        export_title_select: "Exportar Datos",
        export_desc_select: "Selecciona datos para exportar como JSON para análisis de IA.",
        export_opt_lists: "Listas (Me gusta/No me gusta)",
        export_opt_hist: "Historial y Tiempo",
        export_opt_activity: "Registro de Actividad",
        btn_export_selected: "Descargar JSON",
        ...
        feat_custom_sites: "🌐 Sitios <b>Propios</b>",
        ...
        feat_export: "💾 Exportar Datos (JSON)",
        
        tip_export_title: "Exportación y Análisis de IA",
        tip_export_desc: "Analiza tus gustos con ChatGPT",
        tip_export_text: `
            ¿Sabías que puedes exportar todo tu historial y dárselo a una IA? Nuestro archivo JSON está formateado específicamente para que las redes neuronales lo entiendan.<br><br>
            <b>Cómo hacerlo:</b><br>
            1. Ve a la pestaña <b>Cuenta</b> y toca tu cuenta (icono de nube).<br>
            2. Toca <b>Exportar Datos</b> (Función Premium).<br>
            3. Selecciona lo que deseas y descarga el archivo JSON.<br><br>
            <b>¿Qué sigue?</b><br>
            Sube este archivo a ChatGPT o Claude y pregunta:<br>
            <i style="color:var(--text-secondary);">"Analiza mi historial y me gusta. ¿Cuáles son mis preferencias psicológicas ocultas? ¿Qué fetiche específico debería probar basándote en esto?"</i><br><br>
            ¡La IA procesará perfectamente tus acciones y etiquetas, dándote un psicoanálisis detallado!
        `,
    ...
    de: {
        ...
        add_site_btn: "Benutzerdefinierte Website hinzufügen",
        add_site_title: "Neue Website hinzufügen",
        add_site_instr_title: "INSTR_title:",
        add_site_step_1: "Gehen Sie zu der Website, die Sie hinzufügen möchten.",
        add_site_step_2: "Suchen Sie nach dem Wort <b>test</b>.",
        add_site_step_3: "Kopieren Sie die Ergebnis-URL und fügen Sie sie unten ein.",
        lbl_site_name: "NAME",
        lbl_site_url: "URL RESULT",
        lbl_site_desc: "DESCRIPTION",
        btn_save: "Speichern",
        ...
        reward_days: "{n} Tage",
        reward_claimed_status: "Erhalten",
        ...
        tip_badge_title: "Smarte Alarme",
        tip_badge_desc: "Badge & In-App-Popups aktivieren",
        tip_badge_text: `
            <b>Wie es funktioniert:</b><br>
            Das Aktivieren von Benachrichtigungen schaltet zwei Dinge frei:<br>
            1. <b>Roter Punkt (Badge):</b> Eine diskrete Zahl auf dem App-Icon.<br>
            2. <b>In-App-Alarme:</b> Hilfreiche Pop-ups innerhalb der App (wie "Wrapped Bereit" oder "Abo endet").<br><br>
            
            <b>Privatsphäre zuerst:</b><br>
            Wir senden weiterhin <b>keine</b> Push-Benachrichtigungen auf deinen Sperrbildschirm. Du siehst diese Alarme nur, während du die App nutzt. Kein Spam, niemals.
        `,
        ...
        tip_dict_text: `
            <b>🎥 Formate & Stile</b><br>
            <b>POV (Point of View):</b> Aus der Perspektive des Darstellers gefilmt. Du bist der Protagonist.<br>
            <b>PMV (Porn Music Video):</b> Clips, die zum Rhythmus der Musik geschnitten sind.<br>
            <b>Gonzo:</b> Ungeschönte, improvisierte Action, bei der der Kameramann mitwirkt.<br>
            <b>JOI (Jerk Off Instruction):</b> Das Model sagt Ihnen genau, wie und wann Sie sich selbst berühren sollen.<br>
            <b>ASMR:</b> Flüstern und Geräusche für eine entspannende, prickelnde Erfahrung.<br><br>

            <b>👥 Körpertypen</b><br>
            <b>MILF / GILF:</b> Erfahrene Mütter / Großmütter.<br>
            <b>BBW:</b> Große, schöne Frauen (Plus-Size).<br>
            <b>SSBBW:</b> Super Size BBW. Noch größer und weicher.<br>
            <b>PAWG:</b> Phat Ass White Girl (weiße Mädchen mit dickem Hintern).<br>
            <b>Futanari:</b> Anime-Mädchen mit Penis (das Beste aus beiden Welten).<br><br>

            <b>⛓️ Kink & Hardcore</b><br>
            <b>BDSM:</b> Bondage, Dominanz, Sadismus, Masochismus.<br>
            <b>CNC (Consensual Non-Consent):</b> Rollenspiel mit Zwangsszenarien (Safe & Sane).<br>
            <b>CBT (Cock and Ball Torture):</b> Schmerzhaftes Spiel mit männlichen Genitalien.<br>
            <b>SPH (Small Penis Humiliation):</b> Verspottung der Größe zum Vergnügen.<br>
            <b>A2M (Ass to Mouth):</b> Direkt vom Hintereingang zum Mund. <br>
            <b>Creampie:</b> Im Inneren zum Höhepunkt kommen. Ein zeitloser Klassiker. <br>
            <b>Shibari:</b> Die künstlerische japanische Form der Seilfesselung.
        `,
        ...
        tip_vpn_region_title: "Beste VPN-Region für 18+",
        tip_vpn_region_desc: "Die besten Standorte für freien Zugang",
        tip_vpn_region_text: `
            Die Wahl des richtigen Servers ist entscheidend, um Sperren oder nervige Ausweisprüfungen zu vermeiden.<br><br>
            
            <b>🇳🇱 Niederlande (Der Goldstandard)</b><br>
            Die beste Region für Ü18-Inhalte. Alle großen Netzwerke (Pornhub, XVideos, xHamster) und Nischenseiten sind zu 100% ohne Einschränkungen zugänglich.<br><br>
            
            <b>🇺🇸 USA (Altersverifizierungsprobleme)</b><br>
            Instabil. Über 23 Bundesstaaten (wie Texas, Utah) haben Gesetze zur Altersprüfung erlassen. Wenn deine VPN dort landet, <b>blockieren</b> Pornhub und andere den Zugriff komplett. Vermeide USA-Server.<br><br>
            
            <b>🇮🇳 Indien & 🇦🇪 Naher Osten</b><br>
            Strenge Zensur. Fast alle Mainstream-, Hentai- und Nischenseiten sind auf ISP-Ebene gesperrt. Diese Regionen sind für 18+ Surfen unbrauchbar.<br><br>
            
            <b>💡 Pro-Tipp:</b> Stelle deine VPN auf <b>Niederlande, Schweiz oder Rumänien</b> ein, um den sichersten Zugang zu erhalten.
        `,
        ...
        export_title_select: "Daten exportieren",
        export_desc_select: "Wählen Sie Daten für den JSON-Export zur KI-Analyse.",
        export_opt_lists: "Listen (Likes/Dislikes)",
        export_opt_hist: "Verlauf & Zeit",
        export_opt_activity: "Aktivitätsprotokoll",
        btn_export_selected: "JSON Herunterladen",
        ...
        feat_custom_sites: "🌐 <b>Eigene</b> Seiten",
        ...
        feat_export: "💾 Datenexport (JSON)",
        
        tip_export_title: "Export & KI-Analyse",
        tip_export_desc: "Deinen Geschmack mit ChatGPT analysieren",
        tip_export_text: `
            Wusstest du, dass du deinen gesamten Verlauf exportieren und an eine KI verfüttern kannst? Unser JSON-Export ist speziell so formatiert, dass neuronale Netze ihn verstehen.<br><br>
            <b>Wie es geht:</b><br>
            1. Gehe zum Tab <b>Konto</b> und tippe auf dein Profil (Wolken-Symbol).<br>
            2. Tippe auf <b>Daten exportieren</b> (Premium-Funktion).<br>
            3. Wähle die gewünschten Daten und lade die JSON-Datei herunter.<br><br>
            <b>Was dann?</b><br>
            Lade diese Datei bei ChatGPT oder Claude hoch und frage:<br>
            <i style="color:var(--text-secondary);">"Analysiere meinen Verlauf und meine Likes. Was sind meine verborgenen psychologischen Vorlieben? Welchen Fetisch sollte ich als Nächstes ausprobieren?"</i><br><br>
            Die KI wird deine Aktionen und Tags perfekt verarbeiten und dir eine detaillierte Psychoanalyse deiner Fetische geben!
        `,
...
{ 
    id: 'vpn_region', 
    icon: '🌍', 
    titleKey: 'tip_vpn_region_title', 
    descKey: 'tip_vpn_region_desc', 
    textKey: 'tip_vpn_region_text',
    gradient: 'linear-gradient(135deg, #6366f1 0%, #4338ca 100%)' 
},
{ 
    id: 'export_ai', 
    icon: '🤖', 
    titleKey: 'tip_export_title', 
    descKey: 'tip_export_desc', 
    textKey: 'tip_export_text',
    gradient: 'linear-gradient(135deg, #10b981 0%, #047857 100%)' // Изумрудный нейро-градиент
}
];

const TIPS_CATS = {
    tech: ['install_guide', 'mods_guide', 'ads', 'video', 'pay', 'bug', 'panic', 'layout', 'modes', 'export_ai'],
    info: ['sites_guide', 'vpn_region', 'algo_secrets', 'glossary', 'psychotypes', 'intensity', 'missing_wrapped']
};
...
let inactivityTimer;
const INACTIVITY_DELAY = 30 * 60 * 1000; // 30 минут в миллисекундах

function resetInactivityTimer() {
    clearTimeout(inactivityTimer);
    inactivityTimer = setTimeout(() => {
        // Проверяем, не находимся ли мы уже на стартовом экране
        const startBtn = document.getElementById('start-btn-container');
        const isHidden = startBtn && startBtn.classList.contains('hidden-initial');
        const isModeSelect = document.getElementById('mode-start-overlay') && !document.getElementById('mode-start-overlay').classList.contains('hidden');

        // Сбрасываем только если пользователь что-то делал (кнопка старта скрыта) 
        if (isHidden || isModeSelect) {
            console.log("User inactive for 30m. Resetting to home.");
            
            // Если открыты какие-то модалки - закрываем их
            closeAllModals();
...
function initApp() {
    ...
    if (permanentExplored.size === 0 && activityLog.length > 0) {
        activityLog.forEach(log => {
            if (log.id) permanentExplored.add(log.id);
        });
        localStorage.setItem('xch_permanent_explored', JSON.stringify([...permanentExplored]));
        console.log("Explored count restored from logs:", permanentExplored.size);
    }
    updateExploredCount();
...
function showGenreDetails(groupData) {
    ...
    let desc = groupData['desc_' + currentLang] || groupData.desc_en;
    ...
    const badgeStyle = isUnlocked ? '' : 'filter: grayscale(1); opacity: 0.3;';
    
    // Состояние награды PRO
    const isClaimed = (typeof claimedRewards !== 'undefined') && claimedRewards.includes(groupData.id);
    const hasReward = groupData.rewardDays && groupData.rewardDays > 0;
    
    // Формируем текст дней (например: "30 Days" или "30 дн.")
    const daysText = t.reward_days ? t.reward_days.replace('{n}', groupData.rewardDays) : `${groupData.rewardDays} Days`;

    // Создаем блок награды PRO
    let proRewardHtml = '';
    if (hasReward) {
        let boxClass = "pro-reward-visual pro-reward-box";
        let label = daysText;
        
        // По умолчанию клик открывает окно с ценами и преимуществами
        let onClickAction = `closeExploredModal(null, true); openSubModal();`;

        if (!isUnlocked) {
            // Если еще не открыто (висит замок)
            boxClass += " locked";
        } else if (isClaimed) {
            // Если уже забрано (зеленая рамка)
            boxClass += " claimed";
            label = t.reward_claimed_status || "Claimed";
        } else {
            // Если 100% пройдено и можно забрать
            // В этом состоянии клик именно забирает награду
            onClickAction = `claimAchievementReward('${groupData.id}', ${groupData.rewardDays}); event.stopPropagation();`;
            boxClass += " can-claim";
        }

        proRewardHtml = `
            <div class="reward-box" onclick="${onClickAction}" style="cursor:pointer; display:flex; flex-direction:column; align-items:center;">
                <div class="${boxClass}">
                    PRO
                    ${isClaimed ? '<span class="claimed-check">✓</span>' : ''}
                    ${isUnlocked && !isClaimed ? '<div class="shimmer-effect"></div>' : ''}
                </div>
                <div class="ach-status-text ${isUnlocked ? 'unlocked' : ''}" style="font-size:9px; font-weight:800; margin-top:5px; color:${isClaimed ? '#2ecc71' : ''}">
                    ${label}
                </div>
            </div>
        `;
    ...
    details.innerHTML = `
        <div class="genre-header">
            ...
            <div style="width:100%; max-width:200px; margin-bottom:5px;">
                <div class="ex-progress-track" style="height:8px; background:rgba(255,255,255,0.1); border-radius:10px; overflow:hidden;">
                    <div class="ex-progress-fill" style="width: ${groupData.percent}%; height:100%; background:var(--accent); transition: width 0.6s ease;"></div>
                </div>
                <div style="text-align:center; font-size:10px; color:var(--text-secondary); margin-top:5px; font-weight:700;">
                    ${labelExplored}: ${groupData.count} / ${groupData.total}
                </div>
            </div>
        </div>

        <div class="genre-desc-box" style="margin-top:10px;">${desc}</div>

        <div class="genre-samples-title" style="margin-top:20px; font-size:11px; text-transform:uppercase; color:var(--text-secondary); font-weight:700;">
            ${t.lbl_includes || "Includes"}:
        </div>
        <div class="genre-samples-row">${samplesHtml}</div>

        <div class="genre-achievements-header" style="margin-top:25px; border-top:1px solid var(--border); padding-top:15px; font-size:12px; font-weight:800; text-transform:uppercase; color:var(--text-secondary);">${t.ach_title || "Achievements"}</div>
        
        <div class="genre-icons-row" style="display:flex; justify-content:center; gap:20px; margin-top:15px;">
            <!-- 1. ЗНАЧОК -->
            <div class="reward-box" onclick="closeExploredModal(null, true); openAchievementsModal(); showAchievementDetailByID('genre_${groupData.id}')" style="cursor:pointer; display:flex; flex-direction:column; align-items:center;">
                <img src="${groupData.achIcon || 'ach_placeholder.png'}" class="reward-display-img badge-style" style="width:70px; height:70px; object-fit:contain; ${badgeStyle}">
                <div class="ach-status-text ${statusClass}" style="font-size:9px; font-weight:800; margin-top:5px;">${t.lbl_badge || "BADGE"}</div>
            </div>

            <!-- 2. ИКОНКА ПРИЛОЖЕНИЯ -->
            ${groupData.appIcon ? `
            <div class="reward-box" onclick="closeExploredModal(null, true); openThemeModal()" style="cursor:pointer; display:flex; flex-direction:column; align-items:center;">
                <img src="${groupData.appIcon}" class="reward-display-img app-icon-style" style="width:70px; height:70px; border-radius:15px; ${isUnlocked ? '' : 'filter:grayscale(1); opacity:0.3;'}">
                <div class="ach-status-text ${statusClass}" style="font-size:9px; font-weight:800; margin-top:5px;">${t.lbl_icon || "ICON"}</div>
            </div>` : ''}
        ...
        ${isUnlocked && groupData.dateStr ? `<div style="text-align:center; font-size:10px; color:var(--text-secondary); margin-top:20px; opacity:0.6;">${groupData.dateStr}</div>` : ''}
    `;
}
...
function renderSitesList() {
    ...
    // 2. Рендер кастомных сайтов
    if (customSites.length > 0) {
        // Разделитель
        const sep = document.createElement('div');
        sep.className = 'ios-header';
        sep.style.marginTop = '15px';
        sep.innerText = "MY SITES";
        container.appendChild(sep);

        customSites.forEach(site => {
            const isSelected = (site.id === currentSiteId);
            const desc = site.desc[lang];

            const div = document.createElement('div');
            div.className = `site-card ${isSelected ? 'selected' : ''}`;
            // Добавляем padding справа для кнопки удаления
            div.style.paddingRight = "10px";
            
            // Клик по карточке выбирает сайт
            div.onclick = () => selectGlobalSite(site.id);

            div.innerHTML = `
                <div class="site-info" style="max-width: 75%;">
                    <div class="site-name" style="color:var(--accent);">${site.name}</div>
                    <div class="site-desc">${desc}</div>
                </div>
                <div style="display:flex; align-items:center; gap:10px;">
                    <div class="site-check" style="${isSelected ? 'opacity:1; transform:scale(1);' : ''}">✓</div>
                    <div onclick="deleteCustomSite('${site.id}', event)" style="padding:8px; background:rgba(231,76,60,0.1); border-radius:8px; color:var(--highlight-red); font-size:12px;">✕</div>
                </div>
            `;
            container.appendChild(div);
        });
    ...
    // 3. Кнопка "Добавить" в конце
    const isPaid = subscriptionLevel !== 'free';
    
    const addBtn = document.createElement('div');
    addBtn.className = 'site-card';
    addBtn.style.justifyContent = 'center';
    addBtn.style.marginTop = '15px';
    addBtn.style.borderTop = '1px solid var(--border)';
    addBtn.style.color = isPaid ? 'var(--text-main)' : 'var(--text-secondary)';
    addBtn.style.opacity = isPaid ? '1' : '0.6';
    
    // Иконка замка или плюса
    const icon = isPaid ? '+' : '🔒';
    const text = t.add_site_btn || "Add Custom Site";

    addBtn.innerHTML = `<span style="font-weight:700; font-size:14px;">${icon} ${text}</span>`;

    addBtn.onclick = () => {
        if (isPaid) {
            // Закрываем текущее окно выбора и открываем добавление
            closeSitesModal(null, true);
            openAddSiteModal();
        } else {
...
function updateSiteLabelUI() {
    ...
    const siteObj = allSites.find(s => s.id === currentId);
...
function changeLanguage(val) {
    ...
    applyLanguage(); // Переводит статические элементы data-key
    
    // 1. Если мы на стартовом экране (Выбор режима)
    const startOverlay = document.getElementById('mode-start-overlay');
    if (startOverlay && !startOverlay.classList.contains('hidden')) {
        // Перерисовываем приветствие на новом языке
        randomizeModeGreeting(false); 
    }
    
    // 2. Если мы на экране результата (Карточка)
    else if (currentItem) {
        // Обновляем название (имя предмета + модификаторы на новом языке)
        renderResultName(); 
        ...
        // Обновляем фразу-статус (Explanation)
        // Используем сохраненный lastGenerationMode
        const statusEl = document.getElementById('status-text');
        if (statusEl) {
            const explanation = getExplanationText(lastGenerationMode);
            if (explanation) {
                statusEl.innerText = explanation;
            } else {
                // Если объяснения нет (рандом), берем новую рандомную фразу из массива комментариев
                const comments = resultComments[currentLang] || resultComments['en'];
                statusEl.innerText = comments[Math.floor(Math.random() * comments.length)];
            }
        }
        
        updateLink(); 
        renderBadges(); // Перерисовываем бейджи (они локализуются внутри функции)
    }
...
function switchTimeframe(tf) {
    // Блокируем всё кроме "Week" для бесплатных
...
// === ГЛОБАЛЬНЫЕ ПЕРЕМЕННЫЕ КАЛЕНДАРЯ И ЭКСПОРТА ===
let datePickerTarget = 'stats'; // Может быть 'stats' или 'export'
let exportRangeStart = null;
let exportRangeEnd = null;
...
function updateExportPeriodLabel() {
    ...
    if (!exportRangeStart) {
        const t = langData[currentLang] || langData['en'];
        label.innerText = t.tf_all || "All Time";
    } else {
        label.innerText = `${fmt(exportRangeStart)} — ${fmt(exportRangeEnd || exportRangeStart)}`;
    }
}

function openDatePicker(target = 'stats') {
    if (subscriptionLevel === 'free') {
        closeExportModal(null, true);
        closeStats(null, true);
        openSubModal();
        return;
    }
    ...
    // Подгружаем даты в календарь в зависимости от цели
    if (target === 'export') {
        customRangeStart = exportRangeStart ? new Date(exportRangeStart) : null;
        customRangeEnd = exportRangeEnd ? new Date(exportRangeEnd) : null;
    }
...
function applyCustomRange() {
    ...
    // Разветвление логики кнопки "Подтвердить"
    if (datePickerTarget === 'stats') {
        currentStatsTimeframe = 'custom';
        document.querySelectorAll('.stats-tf-item').forEach(el => el.classList.remove('active'));
        document.getElementById('tf-custom').classList.add('active');
        renderStatsContent();
    } else if (datePickerTarget === 'export') {
        exportRangeStart = new Date(customRangeStart);
        exportRangeEnd = new Date(customRangeEnd);
        updateExportPeriodLabel();
        // Календарь закрывается, окно экспорта остается (т.к. оно под ним)
    }
...
function openExportModal() {
    ...
    // Устанавливаем дефолтный период (от первой активности до сегодня)
    if (!exportRangeStart) {
        let firstTs = Date.now();
        if (activityLog.length > 0) firstTs = Math.min(firstTs, activityLog[0].ts);
        if (watchHistory.length > 0) firstTs = Math.min(firstTs, watchHistory[watchHistory.length - 1].timestamp);
        
        exportRangeStart = new Date(firstTs);
        exportRangeStart.setHours(0, 0, 0, 0);
        
        exportRangeEnd = new Date();
        exportRangeEnd.setHours(23, 59, 59, 999);
    }
    
    updateExportPeriodLabel();

    closeSyncInfoModal(null, true);
    document.getElementById('modal-export-selection').classList.add('open');
}

function closeExportModal(e, force) {
    if (force || e.target.id === 'modal-export-selection') {
        document.getElementById('modal-export-selection').classList.remove('open');
    }
}

function performExport() {
    const expLists = document.getElementById('chk-exp-lists').checked;
    const expHist = document.getElementById('chk-exp-hist').checked;
    const expActivity = document.getElementById('chk-exp-activity').checked;
    const expExpl = document.getElementById('chk-exp-expl').checked;
    ...
    const exportObj = {
        metadata: {
            ...
            app: "xFetishHub",
            periodStart: exportRangeStart ? new Date(finalStartTs).toISOString().split('T')[0] : "all",
            periodEnd: exportRangeEnd ? new Date(finalEndTs).toISOString().split('T')[0] : "all"
        },
        data: {}
    };
    ...
    if (expLists) {
        exportObj.data.lists = {
            ...
            disliked: blacklist.map(getName).filter(x => x !== "Unknown"),
            savedForLater: watchLater.map(getName).filter(x => x !== "Unknown")
        };
    }
    ...
    if (expHist) {
        ...
        exportObj.data.watchTime = watchHistory
            .filter(w => w.timestamp >= finalStartTs && w.timestamp <= finalEndTs)
            .map(w => ({
    ...
    if (expActivity) {
        exportObj.data.activityLog = activityLog
            ...
            .map(a => ({
                actionType: a.type,
                name_en: getName(a.id),
                dateStr: new Date(a.ts).toISOString()
            }));
    }
    ...
    downloadAnchorNode.setAttribute("download", `xfetishhub_export_${dateStr}.json`);
...
function renderStatsContent() {
    ...
    // === ОБЩИЕ СТИЛИ ДЛЯ СКРОЛЛ-КОНТЕЙНЕРА  ===
    ...
    // --- ВАРИАНТ А: ПРЕДПОЧТЕНИЯ (PREFERENCES) ---
    if (currentStatsTab === 'tags') {
            ...
            if (log.tags) {
                ...
                if (weight !== 0) {
                    log.tags.forEach(tag => {
                        if(!IGNORED_TAGS.includes(tag)) tempScores[tag] = (tempScores[tag] || 0) + weight;
                    });
                }
            }
        });
        ...
        let html = `<div class="chart-wrapper fade-visible" style="animation: fadeInUp 0.5s ease; height: 280px !important;">
            <div class="chart-scroll-view" id="chart-source-el" style="${scrollContainerStyle}">`;

        if(sortedTags.length === 0) {
            html += `<div style="width:100%; height:100%; display:flex; align-items:center; justify-content:center; color:var(--text-secondary); margin-left: 20px;">${t.stats_no_data}</div>`;
        } else {
            const maxVal = Math.max(...sortedTags.map(x => x[1]));
        
            sortedTags.forEach(([tag, score], index) => {
                const height = Math.max(10, (score / maxVal) * 75);
                
                let displayTag = tag.charAt(0).toUpperCase() + tag.slice(1);
                if (displayTag.length > 9) displayTag = displayTag.substring(0, 7) + '..';

                let delay = index < 5 ? (0.7 - index * 0.1) : 0.05; 

                html += `
                    <div class="pref-col" style="min-width: 55px; margin-right: 8px;">
                        <div class="chart-value-y stagger-text" style="animation-delay:${delay}s; font-size:10px; margin-bottom:4px;">${Math.round(score)}</div>
                        <div class="chart-bar" style="height:0%; animation: growTag${index} 0.5s cubic-bezier(0.2, 0.8, 0.2, 1) forwards ${delay}s;"></div>
                        <div class="chart-label-x stagger-text" title="${tag}" style="animation-delay:${delay}s; margin-top:8px; font-size:10px; white-space:nowrap;">${displayTag}</div>
    ...
    // --- ВАРИАНТ Б: АКТИВНОСТЬ (ACTIVITY) ---
        ...
        let html = `<div class="chart-wrapper fade-visible" style="height: 280px !important;">
            <div class="chart-scroll-view" id="chart-source-el" style="${scrollContainerStyle}">`;
        ...
        if (chartData.length === 0) {
            ...
            const gradGrey = `linear-gradient(180deg, #bdc3c7 0%, #7f8c8d 100%)`; 
            ...
            chartData.forEach((d, index) => {
                ...
                const hNew = (d.newItems / globalMax) * 75;
                const hWatch = (d.watch / globalMax) * 75;
                const hTime = (timeMin / globalMax) * 75;
                
                const delay = index * 0.05;

                html += `
                    <div class="act-col" style="min-width: 85px; margin-right: 15px;">
                        <div class="act-bars-group" style="height: 100%; align-items: flex-end;">
                        ...
                        <div class="act-values-row stagger-text" style="animation-delay:${delay + 0.3}s; margin-top: 5px;">
                        ...
                        <div class="chart-label-x stagger-text" style="animation-delay:${delay + 0.3}s; font-size:11px; margin-top:6px;">${d.label}</div>
                    </div>
                `;
            });
        }
        ...
        let legendNew = currentLang === 'ru' ? 'Открытые' : (currentLang === 'es' ? 'Explorados' : 'Explored');
        ...
        if (scrollView) {
            setTimeout(() => {
                scrollView.scrollTo({ left: scrollView.scrollWidth, behavior: 'smooth' });
            }, 100);
        }
    }
}
...
function applyTheme(themeId, save = true) {
    ...
    // 1. Приветствие (цвета ников в тексте)
    randomizeModeGreeting(false); 

    // 2. Слайдер интенсивности (цвета и фон меняются в Noir)
    updateIntensity(currentIntensity);

    // 3. Кнопки действий (Лайк/Дизлайк) и Статусы
    if (currentItem) {
        updateActionButtons();
        updateCardStatusVisuals();
        renderResultName();
...
function undoLastAction() {
    ...
    if (sessionHistoryStack.length === 0) {
        // Если история пуста, плавно возвращаемся на главный экран
        if (wrapper) {
            wrapper.style.transition = 'transform 0.3s ease-in, opacity 0.3s';
            wrapper.style.transform = 'translateX(100%) rotate(10deg)';
            wrapper.style.opacity = '0';
        }
        setTimeout(() => {
            resetToHome('left'); // Вызываем сброс
        }, 300);
        return;
    }

    // Логика возврата к предыдущему предмету
    if (wrapper) {
        wrapper.style.transition = 'transform 0.3s ease-in, opacity 0.3s';
        wrapper.style.transform = 'translateX(-150%) rotate(-10deg)';
        wrapper.style.opacity = '0';
    ...
    setTimeout(() => {
        ...
        if (wrapper) {
            ...
            setTimeout(() => {
                ...
                wrapper.style.opacity = '1';
                wrapper.classList.remove('anim-fly-left', 'anim-fly-right');
                wrapper.classList.add('anim-fly-right');

                setTimeout(() => {
                    wrapper.classList.remove('anim-fly-right');
                    wrapper.style.transform = '';
                }, 800);
            }, 20);
        }
...
function updateCardStatusVisuals() {
    ...
    if (activeStatus) {
        // Формируем внутренний HTML с текстом и крестиком
        notch.innerHTML = `
            <span id="card-notch-text">${label}</span>
            <div class="notch-close-btn" onclick="removeCurrentStatus(event)">✕</div>
        `;
        ...
        // Плавное появление
        setTimeout(() => {
            if (currentItem) notch.classList.add('visible');
        }, 50);
    }
}

function removeCurrentStatus(e) {
    // Останавливаем всплытие, чтобы не сработал клик по карточке (если он есть)
    if (e) e.stopPropagation();
    
    if (!currentItem) return;
    const id = currentItem.id;

    // 1. Удаляем из всех массивов
    favorites = favorites.filter(x => x !== id);
    blacklist = blacklist.filter(x => x !== id);
    watchLater = watchLater.filter(x => x !== id);
    
    // 2. Если используется itemScores (карма), сбрасываем её для этого ID
    if (typeof itemScores !== 'undefined' && itemScores[id]) {
        delete itemScores[id];
        localStorage.setItem('xch_item_scores', JSON.stringify(itemScores));
    }

    // 3. Сохраняем обновленные списки
    localStorage.setItem('xch_favorites', JSON.stringify(favorites));
    localStorage.setItem('xch_blacklist', JSON.stringify(blacklist));
    localStorage.setItem('xch_watch_later', JSON.stringify(watchLater));

    // 4. Визуальное обновление
    const notch = document.getElementById('card-notch');
    const card = document.getElementById('card-block');
    
    if (notch) notch.classList.remove('visible'); // Плавное исчезновение через CSS
    
    // Убираем подсветку бордера через небольшую паузу (после исчезновения капсулы)
    setTimeout(() => {
        if (card) card.classList.remove('status-wl', 'status-fav', 'status-ban');
    }, 300);

    // 5. Синхронизируем остальные элементы UI
    updateCounts();         // Обновить счетчики в меню
    updateActionButtons();  // Обновить кнопки (Лайк/Дизлайк/WL)
    
    if (window.markDirty) window.markDirty(); // Пометка для синхронизации с облаком
    if (navigator.vibrate) navigator.vibrate(10); // Легкая вибрация
}
...
function resetToHome(entryDirection = 'left') {
    const homeTab = document.getElementById('tab-home');
    ...
    isFirstGen = true; 
    sessionHistoryStack = []; 
    isGenerating = false; // Важно сбросить флаг генерации
    ...
    if(card) {
        ...
        card.style.transform = ''; // Очистка трансформаций
    }

    initIdleSlot();
    randomizeDecorations();

    // 3. ВОССТАНОВЛЕНИЕ СТАРТОВОГО ЭКРАНА
    const totalInteractions = favorites.length + blacklist.length;
    const startBtn = document.getElementById('start-btn-container');
    const overlay = document.getElementById('mode-start-overlay');
    
    // Сброс UI ассистента под корень
    const assistantUI = document.getElementById('assistant-ui');
    const thinkingUI = document.getElementById('thinking-ui');
    ...
    if(assistantUI) assistantUI.classList.remove('visible');
    if(thinkingUI) thinkingUI.style.display = 'none';
    if(startText) startText.classList.remove('fade-out-up'); // Возвращаем видимость текста
    if(modeBtns) modeBtns.classList.remove('fade-out-up');   // Возвращаем видимость кнопок
    ...
    if (totalInteractions >= 10) {
        if(overlay) {
            ...
            overlay.style.pointerEvents = 'auto'; // ГАРАНТИРУЕМ кликабельность
        }
    ...
    // 4. ПОЯВЛЕНИЕ (АНИМАЦИЯ)
    if (wrapper) {
        wrapper.style.transition = 'none';
        const startX = entryDirection === 'right' ? 150 : -150;
        const startRot = entryDirection === 'right' ? 10 : -10;
        
        wrapper.style.transform = `translateX(${startX}%) rotate(${startRot}deg)`;
        wrapper.style.opacity = '0';
        ...
        setTimeout(() => {
            wrapper.style.transition = '';
            // После анимации еще раз проверяем pointer-events
            if (overlay && isModeSelectionActive) overlay.style.pointerEvents = 'auto';
        }, 600);
    }
}
...
function randomizeModeGreeting(forceNew = false) {
    const el = document.getElementById('mode-start-text');
    if (!el) return;
    
    if (forceNew || (!suggestedFavId && !suggestedNewId)) {
        suggestedFavId = null;
        suggestedNewId = null;
        ...
        const randomPool = safePool.sort(() => 0.5 - Math.random()).slice(0, 50).filter(item => !blacklist.includes(item.id) && !favorites.includes(item.id) && item.id !== suggestedFavId);
    ...
    // Получаем локализованные имена на основе ID
    let favName = null;
    let newName = null;

    if (suggestedFavId) {
        const item = data.find(i => i.id === suggestedFavId);
        if (item) favName = getLocalizedName(item);
    }
    if (suggestedNewId) {
        const item = data.find(i => i.id === suggestedNewId);
        if (item) newName = getLocalizedName(item);
    }
    ...
    if (currentTheme === 'noir') {
        colorPleasure = "#ffffff"; 
        colorExplore = "#888888"; 
    } 
    else if (currentTheme === 'old-money') {
        colorPleasure = "#f0e6d2"; 
        colorExplore = "#c5a059"; 
    } 
    else {
...
// === 1. ПРОВЕРКА СПЕЦИАЛЬНЫХ КОМАНД (РАНДОМ) ===
const surpriseKeywords = [
    ...SPECIAL_COMMANDS.surprise[currentLang] || SPECIAL_COMMANDS.surprise.en,
    "random", "randomize", "randomly", "рандом", "рандомно", "рандомный", "случайный", "любой", "что угодно"
];

if (surpriseKeywords.some(kw => rawText.includes(kw))) {
...
function renderModifiersModal() {
    ...
    // А. Собираем полный список доступных модов
    let allAvailable = [];
    
    // Добавляем системные
    modifiersData.forEach(m => allAvailable.push({ key: m.key, label: (m[currentLang] || m.en), isCustom: false }));
    
    // Добавляем кастомные
    customModifiersList.forEach(cKey => {
        if (!allAvailable.find(m => m.key === cKey)) {
            allAvailable.push({ key: cKey, label: cKey, isCustom: true });
        }
    });

    // Б. Рендерим
    allAvailable.forEach(mod => {
        // Если он уже активен, пропускаем
        if (userModifiersPool.includes(mod.key)) return;

        const btn = document.createElement('div');
        btn.className = 'mod-chip inactive';
        
        // Если это кастомный мод, добавляем кнопку полного удаления (корзину/крестик)
        let htmlContent = mod.label;
        if (mod.isCustom) {
            htmlContent += `<span class="custom-mod-del" style="margin-left:6px; font-size:9px; opacity:0.4;" onclick="deleteCustomPermanent('${mod.key}', event)">🗑</span>`;
        }
        
        btn.innerHTML = htmlContent;

        // Клик по чипу добавляет его в активные
        btn.onclick = (e) => {
            // Если кликнули по иконке удаления - не активируем
            ...
            activeMods.add(mod.key); // Сразу активируем логически
    ...
    if (!document.getElementById('custom-mod-form')) {
        ...
        form.innerHTML = `
            <div id="btn-show-custom-input" 
                ...
                style="background: var(--ios-card); border: 1px solid var(--accent); color: var(--accent); border-radius: 50px; padding: 10px 24px; font-size: 13px; font-weight: 700; text-transform: uppercase; cursor: pointer; box-shadow: 0 4px 10px rgba(0,0,0,0.1); transition: transform 0.2s;"
            >+ ${t.mod_add_custom || "Add Custom"}</div>

            <div id="custom-input-container" style="display:none; gap:10px; width:100%;">
                <input type="text" id="custom-mod-input" class="promo-input" placeholder="${t.mod_input_ph || "e.g. Latex..."}" style="font-size:14px; padding:10px;">
                <button class="btn-gen" onclick="submitCustomMod()" style="width:auto; padding:0 20px; font-size:14px; min-width:80px; height:42px;">${t.mod_add_btn || "Add"}</button>
            </div>
        `;
...
function deleteCustomPermanent(key, e) {
    if (e) e.stopPropagation();
    
    if (confirm(`Delete "${key}" permanently?`)) {
        // Удаляем из списка кастомных
        customModifiersList = customModifiersList.filter(k => k !== key);
        localStorage.setItem('xch_custom_mods', JSON.stringify(customModifiersList));
        
        // На всякий случай удаляем из активных (хотя его там быть не должно в этой секции)
...
function triggerLimitShake() {
    const counter = document.getElementById('mods-counter');
    if (!counter) return;
    
    counter.classList.remove('shake-limit-active');
    void counter.offsetWidth; 
    
    counter.classList.add('shake-limit-active');
...
function submitCustomMod() {
    ...
    // 1. Проверка на дубликаты (везде)
    // Если мод уже есть в системе или в кастомном списке
    const systemExists = modifiersData.some(m => m.key === val || m.en === val);
    const customExists = customModifiersList.includes(val);

    if (systemExists) {
        alert("Exists in system mods!");
        return;
    }

    // 2. Добавляем в постоянное хранилище кастомных модов (если еще нет)
    if (!customExists) {
        customModifiersList.push(val);
        localStorage.setItem('xch_custom_mods', JSON.stringify(customModifiersList));
    }

    // 3. Проверка лимита АКТИВНЫХ (Visible on card)
    ...
    if (userModifiersPool.length >= 6) {
        // ЛИМИТ: Просто уведомляем, что добавили в список, но не активировали
        const msg = currentLang === 'ru' 
            ? "Добавлено в список (Лимит активных 6/6)" 
            : "Added to list (Active limit 6/6)";
        
        // Визуально даем понять (тряска счетчика)
        triggerLimitShake();
...
function generateAndSaveWrapped(type) {
    ...
    if (type === 'daily') {
        // Берем последние 24 часа, чтобы захватить сегодняшнюю активность
        startTime = now.getTime() - oneDay;
        // Ключ для уникальности (чтобы не генерить 100 раз в день) - берем текущую дату
        targetDateKey = now.toDateString(); 
    } 
    ...
    // Если активности мало (< 5 действий), не генерируем пустой отчет
    if (relevantLogs.length < 5 && relevantWatch.length === 0) {
        console.log("Not enough data for Wrapped:", relevantLogs.length, "actions");
        return null;
    }
...
function openWrappedUI(dataObj) {
    ...
    const TXT = {
        ...
        // Лояльность
        loyalty_title: {en:"Loyalty Check", ru:"Проверка верности", es:"Chequeo de Lealtad", de:"Loyalitäts-Check"},
        loyalty_old_label: {en:"Old Hits", ru:"Старые хиты", es:"Clásicos", de:"Klassiker"},
        loyalty_new_label: {en:"New Horizons", ru:"Новые горизонты", es:"Nuevos Horizontes", de:"Neue Horizonte"},
        loyalty_title_cons: {en:"The Conservator", ru:"Консерватор", es:"El Conservador", de:"Der Bewahrer"},
        loyalty_title_pioneer: {en:"The Pioneer", ru:"Первооткрыватель", es:"El Pionero", de:"Der Pionier"},
        loyalty_title_balanced: {en:"Balanced Soul", ru:"Баланс сил", es:"Alma Equilibrada", de:"Ausgewogene Seele"},
        loyalty_desc_cons: {en:"You know what you like.", ru:"Ты точно знаешь, чего хочешь.", es:"Sabes lo que te gusta.", de:"Du weißt, was dir gefällt."},
        loyalty_desc_pioneer: {en:"Always chasing the next thrill.", ru:"Вечно в погоне за новым.", es:"Siempre buscando.", de:"Immer auf der Jagd."},
        loyalty_desc_balanced: {en:"Perfect mix.", ru:"Идеальное сочетание.", es:"Mezcla perfecta.", de:"Perfekte Mischung."}
    };
    ...
    // --- Слайд 2: Активность (Если есть данные) ---
    if (stats.totalActions > 0 || stats.totalWatchTime > 0) {
    ...
    // --- Слайд 3: Эволюция (Если есть прошлые теги) ---
    ...
    // --- Слайд 4: Радар (Психотип) ---
    const radarSVG = createRadarChartSVG(stats.psychoCounts, stats.prevPsychoCounts);
    middleSlides.push(`
        <div class="wrapped-slide" style="background: radial-gradient(circle at center, #1a1a1a 0%, #000 100%); justify-content: flex-start; padding-top: 60px;">
            ...
            <div class="reveal-delayed delay-3000" style="text-align:center; width:90%; background:rgba(255,255,255,0.05); padding:20px; border-radius:20px; border:1px solid var(--accent);">
                <div style="font-size:12px; color:var(--text-secondary); text-transform:uppercase; margin-bottom:5px;">${t('sum_psycho')}</div>
                <div style="font-size:28px; font-weight:900; color:#fff; margin-bottom:5px; line-height:1.1; text-transform:uppercase;">${psychoName}</div>
                <div style="font-size:13px; font-style:italic; opacity:0.8;">"${psychoDesc}"</div>
            </div>
        </div>
    `);

    // --- Слайд 5: Топ Фетиши (Только если не Daily) ---
    if (type !== 'daily' && stats.topFetishes && stats.topFetishes.length > 0) {
        let fetishesHTML = '';
        stats.topFetishes.forEach((entry, index) => {
            const name = getLocalizedName(entry.item);
            const rank = index + 1;
            ...
            if (rank === 1) {
                ...
                <div class="cat-rank-row ${rank === 1 ? 'rank-1' : 'anim-list-item'}" style="${rank !== 1 ? `animation-delay:${(5-index)*0.1}s;` : ''}">
                    ...
                    <div style="display:flex; align-items:center; width:100%;">
                        ...
                        <div class="cat-rank-score">🏆</div>
                    </div>
                </div>`;
            } else {
                fetishesHTML += `
                    <div class="cat-rank-row anim-list-item" style="animation-delay:${(5-index) * 0.1}s">
        ...
        middleSlides.push(`
            <div class="wrapped-slide" style="background: linear-gradient(180deg, #141E30 0%, #243B55 100%);">
                <div class="wrapped-sub-text" style="margin-bottom:30px; font-weight:800; text-transform:uppercase; letter-spacing:1px;">${t('top_fetishes_title')}</div>
                <div class="top-cats-container">${fetishesHTML}</div>
            </div>
        `);
    }
    ...
    middleSlides.push(`
        <div class="wrapped-slide" style="background: linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%); overflow: hidden;">
            ...
            <style>.winner-side { transform: scale(1.3) translate(0, 0) !important; z-index: 10; } .loser-side { opacity: 0.2; transform: scale(0.8); filter: blur(2px); } .vs-hidden { opacity: 0; transform: translate(-50%, -50%) scale(0); }</style>
        </div>
    `);
            ...
            <div class="sum-card-new" id="wrapped-summary-card">
                <div class="sum-header">
                    <div class="sum-header-left">
                        <div class="sum-logo-row"><img src="${logoSrc}" class="sum-logo-img"><div class="sum-logo-text">x<span class="grad">Fetish</span>Hub</div></div>
                        <div class="sum-caption">${t('caption')}</div>
                    </div>
                    <div class="sum-qr-box"><img src="${qrUrl}" class="sum-qr-img"></div>
                </div>
                ...
                <div class="sum-grid" style="grid-template-columns: 1fr 1fr; gap: 10px;">
                    <div class="sum-stat-box"><div class="sum-stat-val">${stats.watchCount}</div><div class="sum-stat-lbl">${t('sum_watch')}</div></div>
                    <div class="sum-stat-box"><div class="sum-stat-val">${Math.round(stats.totalWatchTime/60)}m</div><div class="sum-stat-lbl">${t('sum_time')}</div></div>
                    <div class="sum-stat-box" style="grid-column: 1 / -1; background: linear-gradient(135deg, rgba(255,255,255,0.1), rgba(255,255,255,0.05)); border: 1px solid var(--accent); padding: 15px 10px;">
                        ...
                        <div style="font-size:22px; font-weight:900; color:#fff; text-transform:uppercase; line-height:1.1;">${psychoName}</div>
                        <div style="font-size:10px; color:rgba(255,255,255,0.6); margin-top:5px; font-style:italic;">"${psychoDesc}"</div>
                    </div>
                </div>
                <div style="text-align:center; margin-top:5px; border-top:1px solid rgba(255,255,255,0.1); padding-top:15px;">
                    ...
                    <div style="font-size:24px; font-weight:900; color:var(--accent); letter-spacing:1px;">${topGenreTag}</div>
                </div>
            </div>
            <div style="margin-top:30px; display:flex; gap:15px; align-items:center; z-index: 1000;">
                <button onclick="closeWrapped()" class="btn-gen" style="width:auto; padding:12px 40px; font-size:16px; background:rgba(255,255,255,0.15); border:1px solid rgba(255,255,255,0.3); backdrop-filter:blur(10px);">${t('btn_done')}</button>
                <div class="btn-round-share" onclick="shareWrappedCard()"><img src="share.png" alt="Share"></div>
            </div>
        </div>
    `;

    // Перемешивание средних слайдов
    ...
    // ЗАПУСК (С задержкой для рендеринга)
    setTimeout(() => {
        startSlideTimerNew(allSlides.length, 6000); 
    }, 50);

    // Слушатели паузы
    const handlePause = (e) => { 
        if (e.target.closest('button') || e.target.closest('.wrapped-close') || e.target.closest('.btn-round-share')) return;
    ...
    overlay.onmousedown = handlePause;
    overlay.ontouchstart = handlePause;
    overlay.onmouseup = handleResume;
    overlay.ontouchend = handleResume;
}
...
function startSlideTimerNew(total, duration = 6000) {
    ...
    const show = (idx) => {
        ...
        // Запускаем внутренние анимации слайда
        ...
        for(let i=0; i<total; i++) {
            ...
            if (i < idx) { 
                ...
                bar.style.animation = `fillBarAnim ${duration}ms linear forwards`;
            }
        }
    };
...
function toggleModeSettingsRow(show) {
    const row = document.getElementById('row-mode-select');
    if (!row) return;
...
(function initSwipeToClose() {
    ...
    document.addEventListener('touchstart', (e) => {
        ...
        const overlayId = overlay ? overlay.id : null;
        const modalBody = modal.querySelector('.modal-body');
        
        // Список окон с горизонтальным скроллом
        const horizontalConflictModals = ['modal-stats-overlay', 'modal-tips-overlay', 'modal-explored-overlay'];
        ...
        // Если окно из списка конфликтов — разрешаем тянуть ТОЛЬКО за хедер
        if (horizontalConflictModals.includes(overlayId)) {
            if (isHeader) canStartDrag = true;
        } else {
            // В обычных окнах — за хедер или если скролл в самом верху
    ...
    document.addEventListener('touchmove', (e) => {
        ...
        if (deltaY > 0) {
            ...
            if(activeOverlay) activeOverlay.style.backgroundColor = `rgba(0, 0, 0, ${0.6 * opacityProgress})`;
        }
    }, { passive: false });
    ...
    document.addEventListener('touchend', () => {
        ...
        isDragging = false;
        activeModal.classList.remove('swiping');
        
        const deltaY = currentY - startY;

        if (deltaY > CLOSE_THRESHOLD) {
            // Закрываем окно через эмуляцию клика по оверлею или вызов функции
            ...
            setTimeout(() => {
                ...
                if(activeOverlay) activeOverlay.style.backgroundColor = '';
            }, 300);
        } else {
...
function showPushNotification(options) {
    // === НОВАЯ ПРОВЕРКА ===
    // Если уведомления не разрешены в системе (тумблер выключен) — выходим
    if (Notification.permission !== 'granted') {
        console.log("Push notification blocked: Permissions not granted");
        return;
    }
    // ======================
...
async function claimAchievementReward(groupId, days) {
    if (claimedRewards.includes(groupId)) return;
    
    const user = window.auth ? window.auth.currentUser : null;
    const t = langData[currentLang] || langData['en'];

    // 1. Рассчитываем новую дату окончания
    let currentExpire = Date.now();
    
    // Если уже есть подписка Pro, продлеваем её
    if (subscriptionLevel === 'pro' && window.cachedUserProfile?.expiresAt) {
        const d = window.cachedUserProfile.expiresAt;
        currentExpire = d.toDate ? d.toDate().getTime() : new Date(d).getTime();
    }
    ...
    if (subscriptionLevel === 'free' || subscriptionLevel === 'pro') {
        ...
        // Если залогинен — шлем в Firebase
        if (user) {
            try {
                const { doc, updateDoc, Timestamp } = await import("https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js");
                const db = window.db || (await import("https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js")).getFirestore();
                await updateDoc(doc(db, "users", user.uid), {
                    subscription: 'pro',
                    expiresAt: Timestamp.fromDate(newExpire)
                });
            } catch (e) { console.error("Cloud reward sync failed", e); }
        }
    }

    // 3. Сохраняем факт получения
    claimedRewards.push(groupId);
    localStorage.setItem('xch_claimed_rewards', JSON.stringify(claimedRewards));
    
    // UI
    updateSubscriptionUI();
    alert(currentLang === 'ru' ? `Награда получена! +${days} дн. PRO` : `Reward claimed! +${days} days of PRO`);
...
function openAddSiteModal() {
    ...
    document.getElementById('custom-site-desc').value = '';
    
    document.getElementById('modal-add-site-overlay').classList.add('open');
}

function closeAddSiteModal(e, force) {
    if (force || e.target.id === 'modal-add-site-overlay') {
        document.getElementById('modal-add-site-overlay').classList.remove('open');
    }
}
...
function saveCustomSite() {
    ...
    let url = document.getElementById('custom-site-url').value.trim();
    ...
    const newSite = {
        ...
        isCustom: true,
        tags: ['custom'],
        desc: { en: desc, ru: desc, es: desc, de: desc }
    };

    customSites.push(newSite);
    localStorage.setItem('xch_custom_sites', JSON.stringify(customSites));
...
// Удаление сайта
function deleteCustomSite(id, e) {
    e.stopPropagation();
    ...
    if (localStorage.getItem('xch_platform') === id) {
        selectGlobalSite('xh');
    } else {
        renderSitesList();
    }
...
// === Блокировка прохождения кликов сквозь модальные окна ===
document.addEventListener('DOMContentLoaded', () => {
    // Находим все окна
